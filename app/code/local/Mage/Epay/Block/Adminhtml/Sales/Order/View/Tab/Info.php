...
class Mage_Epay_Block_Adminhtml_Sales_Order_View_Tab_Info extends Mage_Adminhtml_Block_Sales_Order_View_Tab_Info implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    public function printLogo($cardid) {
		...
		switch($cardid)
		{
			case '1':
				{
					$res .= $this->getSkinUrl('images/epay/dankort.gif');
					break;
				}
			case '2':
				{
			...
			case '3':
				{
					$res .= $this->getSkinUrl('images/epay/visaelectron.gif');
					break;
				}
			case '4':
				{
					$res .= $this->getSkinUrl('images/epay/mastercard.gif');
					break;
				}
			case '5':
				{
			...
			case '7':
				{
					$res .= $this->getSkinUrl('images/epay/jcb.gif');
					break;
				}
			case '8':
				{
					$res .= $this->getSkinUrl('images/epay/diners.gif');
					break;
				}
			case '9':
				{
					$res .= $this->getSkinUrl('images/epay/maestro.gif');
					break;
				}
			case '10':
				{
					$res .= $this->getSkinUrl('images/epay/amex.gif');
					break;
				}
			case '12':
				{
					$res .= $this->getSkinUrl('images/epay/edankort.gif');
					break;
				}
			case '13':
				{
			...
			case '16':
				{
					$res .= $this->getSkinUrl('images/epay/forbrugsforeningen.gif');
					break;
				}
			case '17':
				{
					$res .= $this->getSkinUrl('images/epay/ewire.gif');
					break;
				}
			case '18':
				{
					$res .= $this->getSkinUrl('images/epay/visa.gif');
					break;
				}
			case '24':
				{
