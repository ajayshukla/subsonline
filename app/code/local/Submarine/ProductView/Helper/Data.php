...
class Submarine_ProductView_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function prepareAndRender($productId, $controller, $params = null)
    {
        ...
        #$controller->initLayoutMessages(array('catalog/session', 'tag/session', 'checkout/session'))->renderLayout();
