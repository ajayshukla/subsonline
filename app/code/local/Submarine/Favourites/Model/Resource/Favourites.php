...
/**
 * Favourites resource model
 *
 * @category    Mage
 * @package     Submarine_Favourites
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Submarine_Favourites_Model_Resource_Favourites extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
     * Store favourites items count
     *
     * @var null|int
     */
    ...
    {
        $this->_init('favourites/favourites', 'favourites_id');
    }
     ...
     * @param $fieldName
     *
     * @return Submarine_Favourites_Model_Resource_Favourites
     */
     ...
     * @see Submarine_Favourites_Model_Favourites::getItemsCount()
     *
     * @param Submarine_Favourites_Model_Favourites $favourites
     *
     * @return int
     */
    public function fetchItemsCount(Submarine_Favourites_Model_Favourites $favourites)
    {
        if (is_null($this->_itemsCount)) {
            $this->_itemsCount = $favourites->getItemsCount();
        }
