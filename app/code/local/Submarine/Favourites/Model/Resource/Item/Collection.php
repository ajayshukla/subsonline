 ...
 */
class Submarine_Favourites_Model_Resource_Item_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /**
     ...
     *
     * @return Submarine_Favourites_Model_Resource_Item_Collection
     */
    ...
    protected function _assignOptions()
    {
        ...
        /* @var $optionCollection Submarine_Favourites_Model_Resource_Item_Option_Collection */
        $optionCollection = Mage::getModel('favourites/item_option')->getCollection();
    ...
    protected function _assignProducts()
    {
        ...
        $attributes = Mage::getSingleton('favourites/config')->getProductAttributes();
        ...
        Mage::dispatchEvent('favourites_item_collection_products_after_load', array(
    ...
    /**
     * Add filter by favourites object
     *
    ...
    {
        $this->addFieldToFilter('favourites_id', $favourites->getId());
        return $this;
    }
     ...
     * - we need it to make favourites item collection interface as much as possible compatible with old
     ...
     * @return Submarine_Favourites_Model_Resource_Item_Collection
     */
    public function addDaysInFavourites()
    {
        $this->_addDaysInFavourites = true;
        ...
        $this->getSelect()->columns(array('days_in_favourites' => $dateDiff));
        return $this;
    }

    /**
     * Adds filter on days in favourites
     *
    ...
    public function getItemsQty(){
        if (is_null($this->_itemsQty)) {
            $this->_itemsQty = 0;
            foreach ($this as $favouritesItem) {
                $qty = $favouritesItem->getQty();
