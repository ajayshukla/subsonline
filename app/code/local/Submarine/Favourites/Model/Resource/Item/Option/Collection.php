...
/**
 * Favourites item option collection
 *
 * @category    Mage
 * @package     Submarine_Favourites
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Submarine_Favourites_Model_Resource_Item_Option_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /**
    ...
    {
        $this->_init('favourites/item_option');
    }

    /**
     * Fill array of options by item and product
     *
     * @return Submarine_Favourites_Model_Resource_Item_Option_Collection
     */
    protected function _afterLoad()
    {
        ...
        foreach ($this as $option) {
            ...
            $itemId     = $option->getFavouritesItemId();
    ...
    public function addItemFilter($item)
    {
        if (empty($item)) {
            ...
            $this->addFieldToFilter('favourites_item_id', array('in' => $item));
        } else if ($item instanceof Submarine_Favourites_Model_Item) {
            $this->addFieldToFilter('favourites_item_id', $item->getId());
        } else {
            $this->addFieldToFilter('favourites_item_id', $item);
        }
